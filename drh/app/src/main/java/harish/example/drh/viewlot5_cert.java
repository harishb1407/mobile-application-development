...
public class viewlot5_cert extends AppCompatActivity {

    private TextView product, quantity;
    private TextView r02, r03, r04, r05, r06, r2, r3, r4, r5, r6, r7, r22, r32, r42, r52, r62, r72, r23, r33, r43, r53, r63, r73;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_viewlot5_cert);
        ...
        DatabaseReference ref_lot_content_cert = FirebaseDatabase.getInstance().getReference().child("FiveLot cert").child("five lots dropdown cert");
        ref_lot_content_cert.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                r7.setText(appearance_cert_spec);
