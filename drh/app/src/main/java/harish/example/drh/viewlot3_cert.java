...
public class viewlot3_cert extends AppCompatActivity {

    private TextView product, quantity;
    private TextView r02, r03, r04, r2, r3, r4, r5, r22, r32, r42, r52, r23, r33, r43, r53;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_viewlot3_cert);
        ...
        DatabaseReference ref_lot_content_cert = FirebaseDatabase.getInstance().getReference().child("ThreeLot cert").child("three lots dropdown cert");
        ref_lot_content_cert.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                r5.setText(appearance_cert_spec);
