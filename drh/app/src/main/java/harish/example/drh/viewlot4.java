...
public class viewlot4 extends AppCompatActivity {

    private TextView to, name, pro, packno, quantity;
    private TextView r1, r2, r3, r4, r5, r6, r12, r22, r32, r42, r52, r62, r13, r23, r33, r43, r53, r63, r14, r24, r34, r44, r54, r64;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_viewlot4);
        ...
        r44 = (TextView)findViewById(R.id.r44);
        r54 = (TextView)findViewById(R.id.r54);
        r64 = (TextView)findViewById(R.id.r64);
        ...
        DatabaseReference ref_lot_content = FirebaseDatabase.getInstance().getReference().child("FourLot").child("four lots dropdown");
        ref_lot_content.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                String lot_pack_4 = snapshot.child("lot_pack_4").getValue().toString();
                r14.setText(lot_pack_4);
                String bag_pack_4 = snapshot.child("bag_pack_4").getValue().toString();
                r24.setText(bag_pack_4);
                String nobag_pack_4 = snapshot.child("nobag_pack_4").getValue().toString();
                r34.setText(nobag_pack_4);
                String gross_pack_4 = snapshot.child("gross_pack_4").getValue().toString();
                r44.setText(gross_pack_4);
                String tare_pack_4 = snapshot.child("tare_pack_4").getValue().toString();
                r54.setText(tare_pack_4);
                String net_pack_4 = snapshot.child("net_pack_4").getValue().toString();
                r64.setText(net_pack_4);

                String sum_nobag_pack = Double.toString(Double.parseDouble(r3.getText().toString()) + Double.parseDouble(r32.getText().toString()) + Double.parseDouble(r33.getText().toString()) + Double.parseDouble(r34.getText().toString()));
                s3.setText(sum_nobag_pack);
                String sum_gross_pack = Double.toString(Double.parseDouble(r4.getText().toString()) + Double.parseDouble(r42.getText().toString()) + Double.parseDouble(r43.getText().toString()) + Double.parseDouble(r44.getText().toString()));
                s4.setText(sum_gross_pack);
                String sum_tare_pack = Double.toString(Double.parseDouble(r5.getText().toString()) + Double.parseDouble(r52.getText().toString()) + Double.parseDouble(r53.getText().toString()) + Double.parseDouble(r54.getText().toString()));
                s5.setText(sum_tare_pack);
                String sum_net_pack = Double.toString(Double.parseDouble(r6.getText().toString()) + Double.parseDouble(r62.getText().toString()) + Double.parseDouble(r63.getText().toString()) + Double.parseDouble(r64.getText().toString()));
