...
public class lot5_cert extends AppCompatActivity {
    ...
    EditText lot_cert_5, purity_cert_5;
    Spinner spin2_cert, spin3_cert, spin2_cert_2, spin3_cert_2, spin2_cert_3, spin3_cert_3, spin2_cert_4, spin3_cert_4, spin2_cert_5, spin3_cert_5;
    FiveLot_cert fiveLot_cert;
    DatabaseReference reff_5lot_cert;

    Button confirm_cert, view_cert;
    Intent view_lot5_cert;

    public static String appearance_cert, tlc_cert, appearance_cert_2, tlc_cert_2, appearance_cert_3, tlc_cert_3, appearance_cert_4, tlc_cert_4, appearance_cert_5, tlc_cert_5;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_lot5_cert);
        ...
        view_lot5_cert = new Intent(lot5_cert.this, viewlot5_cert.class);
        ...
        fiveLot_cert = new FiveLot_cert();
        reff_5lot_cert = FirebaseDatabase.getInstance().getReference().child("FiveLot cert");
        ...
        confirm_cert.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                fiveLot_cert.setEdit_text_lot_cert(edit_text_lot_cert);
                fiveLot_cert.setEdit_text_purity_cert(edit_text_purity_cert);
                fiveLot_cert.setEdit_text_lot_cert_2(edit_text_lot_cert_2);
                fiveLot_cert.setEdit_text_purity_cert_2(edit_text_purity_cert_2);
                fiveLot_cert.setEdit_text_lot_cert_3(edit_text_lot_cert_3);
                fiveLot_cert.setEdit_text_purity_cert_3(edit_text_purity_cert_3);
                fiveLot_cert.setEdit_text_lot_cert_4(edit_text_lot_cert_4);
                fiveLot_cert.setEdit_text_purity_cert_4(edit_text_purity_cert_4);
                fiveLot_cert.setEdit_text_lot_cert_5(edit_text_lot_cert_5);
                fiveLot_cert.setEdit_text_purity_cert_5(edit_text_purity_cert_5);

                fiveLot_cert.setEdit_text_appearance_cert_spec(appearance_cert_spec.getText().toString().trim());
                fiveLot_cert.setEdit_text_purity_cert_spec(purity_cert_spec.getText().toString().trim());
                fiveLot_cert.setEdit_text_tlc_cert_spec(tlc_cert_spec.getText().toString());

                fiveLot_cert.setAppearance_cert(appearance_cert);
                fiveLot_cert.setTlc_cert(tlc_cert);
                fiveLot_cert.setAppearance_cert_2(appearance_cert_2);
                fiveLot_cert.setTlc_cert_2(tlc_cert_2);
                fiveLot_cert.setAppearance_cert_3(appearance_cert_3);
                fiveLot_cert.setTlc_cert_3(tlc_cert_3);
                fiveLot_cert.setAppearance_cert_4(appearance_cert_4);
                fiveLot_cert.setTlc_cert_4(tlc_cert_4);
                fiveLot_cert.setAppearance_cert_5(appearance_cert_5);
                fiveLot_cert.setTlc_cert_5(tlc_cert_5);

                reff_5lot_cert.child("five lots dropdown cert").setValue(fiveLot_cert);
                Toast.makeText( lot5_cert.this, "Lot values confirmed", Toast.LENGTH_LONG).show();
