...
public class table4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        element1_quantity = (TextView)findViewById(R.id.t4_element1_quantity);
        element1_cost = (TextView)findViewById(R.id.t4_element1_cost);
        element2_quantity = (TextView)findViewById(R.id.t4_element2_quantity);
        element2_cost = (TextView)findViewById(R.id.t4_element2_cost);
        element3_quantity = (TextView)findViewById(R.id.t4_element3_quantity);
        element3_cost = (TextView)findViewById(R.id.t4_element3_cost);
        load_data = (Button)findViewById(R.id.t4_load_data);
