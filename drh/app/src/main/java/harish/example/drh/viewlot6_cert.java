...
public class viewlot6_cert extends AppCompatActivity {

    private TextView product, quantity;
    private TextView r02, r03, r04, r05, r06, r07, r2, r3, r4, r5, r6, r7, r8, r22, r32, r42, r52, r62, r72, r82, r23, r33, r43, r53, r63, r73, r83;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_viewlot6_cert);
        ...
        r06 = (TextView)findViewById(R.id.r06);
        r07 = (TextView)findViewById(R.id.r07);
        ...
        r72 = (TextView)findViewById(R.id.r72);
        r82 = (TextView)findViewById(R.id.r82);
        ...
        r73 = (TextView)findViewById(R.id.r73);
        r83 = (TextView)findViewById(R.id.r83);
        ...
        DatabaseReference ref_lot_content_cert = FirebaseDatabase.getInstance().getReference().child("SixLot cert").child("six lots dropdown cert");
        ref_lot_content_cert.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                String lot_cert_5 = snapshot.child("edit_text_lot_cert_5").getValue().toString();
                r06.setText(lot_cert_5);
                String lot_cert_6 = snapshot.child("edit_text_lot_cert_6").getValue().toString();
                r07.setText(lot_cert_6);
                ...
                String appearance_cert_5 = snapshot.child("appearance_cert_5").getValue().toString();
                r6.setText(appearance_cert_5);
                String appearance_cert_6 = snapshot.child("appearance_cert_6").getValue().toString();
                r7.setText(appearance_cert_6);
                String appearance_cert_spec = snapshot.child("edit_text_appearance_cert_spec").getValue().toString();
                r8.setText(appearance_cert_spec);
                ...
                String purity_cert_5 = snapshot.child("edit_text_purity_cert_5").getValue().toString();
                r62.setText(purity_cert_5);
                String purity_cert_6 = snapshot.child("edit_text_purity_cert_6").getValue().toString();
                r72.setText(purity_cert_6);
                String purity_cert_spec = snapshot.child("edit_text_purity_cert_spec").getValue().toString();
                r82.setText(purity_cert_spec);
                ...
                String tlc_cert_5 = snapshot.child("tlc_cert_5").getValue().toString();
                r63.setText(tlc_cert_5);
                String tlc_cert_6 = snapshot.child("tlc_cert_6").getValue().toString();
                r73.setText(tlc_cert_6);
                String tlc_cert_spec = snapshot.child("edit_text_tlc_cert_spec").getValue().toString();
                r83.setText(tlc_cert_spec);
