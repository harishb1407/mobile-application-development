...
public class viewlot2_cert extends AppCompatActivity {

    private TextView product, quantity;
    private TextView r02, r03, r2, r3, r4, r22, r32, r42, r23, r33, r43;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_viewlot2_cert);
        ...
        DatabaseReference ref_lot_content_cert = FirebaseDatabase.getInstance().getReference().child("TwoLot cert").child("two lots dropdown cert");
        ref_lot_content_cert.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                r4.setText(appearance_cert_spec);
