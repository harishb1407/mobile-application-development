...
public class viewlot2 extends AppCompatActivity {

    private TextView to, name, pro, packno, quantity;
    private TextView r1, r2, r3, r4, r5, r6, r12, r22, r32, r42, r52, r62;
    private TextView s3, s4, s5, s6;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_viewlot2);
        ...
        DatabaseReference ref_lot_content = FirebaseDatabase.getInstance().getReference().child("TwoLot").child("two lots dropdown");
        ref_lot_content.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                String sum_nobag_pack = Double.toString(Double.parseDouble(r3.getText().toString()) + Double.parseDouble(r32.getText().toString()));
                s3.setText(sum_nobag_pack);
                String sum_gross_pack = Double.toString(Double.parseDouble(r4.getText().toString()) + Double.parseDouble(r42.getText().toString()));
                s4.setText(sum_gross_pack);
                String sum_tare_pack = Double.toString(Double.parseDouble(r5.getText().toString()) + Double.parseDouble(r52.getText().toString()));
                s5.setText(sum_tare_pack);
                String sum_net_pack = Double.toString(Double.parseDouble(r6.getText().toString()) + Double.parseDouble(r62.getText().toString()));
